    ...
    return {
        DEFAULT: {
            css: {
                ...
                "--tw-prose-links": theme("colors.current.500"),
                "--tw-prose-links-hover": theme("colors.current.600"),
                "--tw-prose-links-underline": theme("colors.current.500 / 0.3"),
                ...
                "--tw-prose-invert-links": theme("colors.current.400"),
                "--tw-prose-invert-links-hover": theme("colors.current.500"),
                "--tw-prose-invert-links-underline": theme(
                    "colors.current.500 / 0.3",
                ),
